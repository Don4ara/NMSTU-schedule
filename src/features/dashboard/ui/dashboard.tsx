        ...
        >
            <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-3 gap-6 auto-rows-min my-auto">
                ...
                <div className="lg:col-span-2 flex flex-col gap-6">
                    {/* Hero Card */}
                    <div className="bg-white rounded-3xl p-6 md:p-8 border border-slate-200 shadow-sm relative overflow-hidden flex flex-col justify-between min-h-[320px] group">
                        {/* Dynamic Backgrounds */}
                    ...
                    {/* Clock */}
                    <div className="bg-slate-900 rounded-3xl p-6 shadow-sm text-white flex flex-col justify-between relative overflow-hidden h-[160px] border border-slate-900 shrink-0">
                ...
                <div className="lg:col-span-1 bg-white rounded-3xl border border-slate-200 shadow-sm p-6 flex flex-col relative overflow-hidden h-fit">
